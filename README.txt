...
a persistence unit "preuba63TaniaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "preuba63Tania/pom.xml":
...
artifact ("preuba63Tania.war") is already built. You can build
